...
public class TestMergeKListsSolutionOnlogk {

    MergeKListsSolutionOnlogk test = new MergeKListsSolutionOnlogk();
    ...
    @Test
    public void testMergeKListsSolution04() {
        int[] num1 = new int[]{-1,-1,-1};
        int[] num2 = new int[]{-2,-2,-1};
        ListNode list1 = generateLink(num1);
        ListNode list2 = generateLink(num2);
        ListNode[] param = new ListNode[]{list1,list2};
        List<Integer> resultNum = new ArrayList<Integer>(Arrays.asList(-2,-2,-1,-1,-1,-1));
        Assertions.assertEquals(resultNum,linkedlistToArray(test.mergeKLists(param)));
    }
}
